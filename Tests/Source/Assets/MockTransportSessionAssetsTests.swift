...
class MockTransportSessionAssetsTests : MockTransportSessionTests {
    ...
    func testUploadingAssetRequestV3() {
        ...
        // when
        let response = self.response(forAssetData: data, contentType: "application/octet-stream", path: "/assets/v3", apiVersion: 0)
    ...
    func testDownloadingNonexistingAssetRequestV3() {
        // when
        let response = self.response(forPayload: nil, path: "/assets/v3/12345", method: .methodGET, apiVersion: 0)
    ...
    func testDownloadingExistingAssetRequestV3() {
        ...
        // when
        let response = self.response(forPayload: nil, path: "/assets/v3/\(asset!.identifier)", method: .methodGET, apiVersion: 0)
    ...
    func testDeletingNonexistingAssetRequestV3() {
        // when
        let response = self.response(forPayload: nil, path: "/assets/v3/12345", method: .methodDELETE, apiVersion: 0)
    ...
    func testDeletingExistingAssetRequestV3() {
        ...
        // when
        let response = self.response(forPayload: nil, path: "/assets/v3/\(asset!.identifier)", method: .methodDELETE, apiVersion: 0)
        XCTAssertNotNil(response)
    ...
    func testUploadingAssetRequestV4() {
        ...
        // when
        let domain = UUID.create().transportString()
        let response = self.response(forAssetData: data, contentType: "application/octet-stream", path: "/assets/v4/\(domain)", apiVersion: 0)
        XCTAssertNotNil(response)
    ...
    func testDownloadingNonexistingAssetRequestV4() {
        ...
        let domain = UUID.create().transportString()
        let response = self.response(forPayload: nil, path: "/assets/v4/\(domain)/\(key)", method: .methodGET, apiVersion: 0)
    ...
    func testDownloadingExistingAssetRequestV4() {
        ...
        // when
        let response = self.response(forPayload: nil, path: "/assets/v4/\(asset!.domain!)/\(asset!.identifier)", method: .methodGET, apiVersion: 0)
    ...
    func testDeletingNonexistingAssetRequestV4() {
        ...
        let key = UUID.create().transportString()
        let domain = UUID.create().transportString()
        let response = self.response(forPayload: nil, path: "/assets/v4/\(domain)/\(key)", method: .methodDELETE, apiVersion: 0)
    ...
    func testDeletingExistingAssetRequestV4() {
        ...
        // when
        let response = self.response(forPayload: nil, path: "/assets/v4/\(asset!.domain!)/\(asset!.identifier)", method: .methodDELETE, apiVersion: 0)
        XCTAssertNotNil(response)
        XCTAssertEqual(response?.httpStatus, 200)
